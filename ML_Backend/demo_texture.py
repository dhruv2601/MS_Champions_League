...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--image_path', default='TestImages/AFLW2000/brad.jpg', type=str,
                        help='path to input image')
    parser.add_argument('-r', '--ref_path', default='TestImages/brad.jpg', type=str, 
                        help='path to reference image(texture ref)')
    parser.add_argument('-o', '--output_path', default='TestImages/output.png', type=str, 
