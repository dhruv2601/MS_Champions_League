...
public class WavefrontLoader2 {
    ...
    public static void loadAsync(final AppCompatActivity parent, URL url, final File currentDir,
...
//						return new FileInputStream(new File(currentDir, modelId));
                        Log.d("ZlTag", "inside currentDir");
                        Log.d("ZlTag", "url:: "+ currentDir+"/"+modelId);
                        return new FileInputStream(new File(String.valueOf(currentDir+"/"+modelId)));
                    } else if (assetsDir != null) {
                        Log.d("ZlTag", "inside assetsDir");
                        return new FileInputStream(new File(String.valueOf(currentDir+"/"+modelId)));
