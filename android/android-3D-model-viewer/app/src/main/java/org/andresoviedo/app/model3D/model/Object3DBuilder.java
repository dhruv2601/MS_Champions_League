...
// 		if (true) return obj;
	...
	public static void loadV6AsyncParallel(final AppCompatActivity parent, final URL url, final File file, final String assetsDir, final String assetName,
	...
	public static void loadV6AsyncParallel_Obj(final AppCompatActivity parent, final File file, final String assetsDir, final String assetName,
                                               final Callback callback) {
