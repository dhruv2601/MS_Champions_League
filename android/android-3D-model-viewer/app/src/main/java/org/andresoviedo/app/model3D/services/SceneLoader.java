...
//                        makeToastText("Load complete (" + elapsed + ")", Toast.LENGTH_LONG);
    ...
    private void animateObjectOnY(Object3DData data) {
        long time = SystemClock.uptimeMillis() % 5000L;
        float angleInDegrees = (180.0f / 5000.0f) * ((int) time);
        data.setRotationY(angleInDegrees);
    }
