...
public final class STLLoader {
	...
	public static void loadSTLAsync(final AppCompatActivity parent, URL url, final Object3DBuilder.Callback callback) {
	...
	private static class STLLoaderTask extends LoaderTask {
		...
		STLLoaderTask(AppCompatActivity parent, URL url, Object3DBuilder.Callback callback){
